...
public class MultiplayerPlayerOnline : MonoBehaviour
{
    ...
    protected void Throw()
    {
        ...
        if (_FrisbeeScript.PlayerOneCaught == true)
        {
            ...
            {
                this.gameObject.GetComponent<PhotonView>().RPC("SpecialThrowRPC", PhotonTargets.All);
            }
            else if (Input.GetButtonDown("Throw"))
            {
                ...
                _FrisbeeScript.PlayerOneCaught = false;
                isThrown = true;
                this.gameObject.GetComponent<PhotonView>().RPC("DetachTheChildren", PhotonTargets.All);
            }
        }
    ...
    [RPC]
    protected void DetachTheChildren()
    {
        transform.DetachChildren();
        _FrisbeeScript.PlayerOneCaught = false;
    }
    [RPC]
    protected void SpecialThrowRPC()
    {
        special = true;
        _FrisbeeScript.PlayerOneCaught = false;
        isThrown = true;
